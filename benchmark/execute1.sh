...
export TDOC=/home/infinity/Desktop/benchmark
...
python3 "$SRCDIR/uitest/test_main.py" --soffice=path:"$SRCDIR/instdir/program/soffice"  --userdir=file:///tmp/libreoffice/4 --file=/home/infinity/Desktop/myuitest.py
